					...
					<div class="collapse" id="search-nav">
						<form class="navbar-left navbar-form nav-search mr-md-3">
							<div class="input-group">
								...
								<input type="text" placeholder="Search {{ asset('Atlantis')}}." class="form-control">
							</div>
						</form>
					</div>
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
										...
										<div class="notif-center">
											...
											<a href="#">
												...
												<div class="notif-content">
													...
													<span class="block">
														Ready for the meeting today{{ asset('Atlantis')}}.
													</span>
													<span class="time">12 minutes ago</span> 
												</div>
											</a>
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="{{ asset('Atlantis')}}/assets/img/profile.jpg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
								</div>
							</a>
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="{{ asset('Atlantis')}}/assets/img/logoproduct.svg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="{{ asset('Atlantis')}}/assets/img/logoproduct3.svg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="{{ asset('Atlantis')}}/assets/img/jm_denis.jpg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{ asset('Atlantis')}}/assets/img/chadengle.jpg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{ asset('Atlantis')}}/assets/img/talha.jpg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{ asset('Atlantis')}}/assets/img/mlane.jpg" alt="{{ asset('Atlantis')}}." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
